...
namespace GraphTheory.Internal.OdinSerializer
{
    using GraphTheory.Internal.OdinSerializer.Utilities;
    using GraphTheory.Internal.OdinSerializer.Utilities.Unsafe;
    using System;
