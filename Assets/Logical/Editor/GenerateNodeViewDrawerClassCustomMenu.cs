...
namespace Logical.Editor
{
    public class GenerateNodeViewDrawerClassCustomMenu : CustomMenuElement
    {
        ...
        public GenerateNodeViewDrawerClassCustomMenu()
        {
            var uxmlAsset =
                Resources.Load<VisualTreeAsset>(ResourceAssetPaths.GenerateNodeViewDrawerClassCustomMenu_UXML);
        ...
        private void SetupPopupOptions()
        {
            ...
            {
                foreach (Type nodeType in GraphTypeMetadata.GraphToNodes[graphType])
                {
                    bool exists = GraphTypeMetadata.NodeToNodeViewDrawer.ContainsKey(nodeType);
                    if (exists)
                    {
        ...
        private void OnRelatedNodeClassDraw()
        {
            ...
            m_relatedNodeSelectedIndex = EditorGUILayout.Popup(new GUIContent(" Related Node Class"),
                m_relatedNodeSelectedIndex, m_nodeClassPopupOptions.ToArray());
