...
namespace Logical.Editor
{
    public class CreateGraphInstanceCustomMenu : CustomMenuElement
    {
        ...
        public CreateGraphInstanceCustomMenu()
        {
        ...
        private void OnCreateButtonPressed()
        {
            ...
            //createdGraph.GraphProperties = (AGraphProperties)Activator.CreateInstance(GraphTypeMetadata.GetGraphPropertiesType(m_allGraphTypes[m_selectedIndex]));
