...
namespace Logical.Editor
{
    ...
    /// https://github.com/Unity-Technologies/UnityCsReference/blob/master/Modules/GraphViewEditor/Manipulators/ContentDragger.cs
    /// Added callback to get every drag update in NodeGraphView.
    /// 
    ///     CustomContentDragger contentDragger = new CustomContentDragger();
    ///     this.AddManipulator(contentDragger);
    ///     // And subscribe to contentDragger.PositionChanged as necessary.
    /// 
    /// </summary>
    public class CustomContentDragger : MouseManipulator
    {
        ...
        protected Rect CalculatePosition(float x, float y, float width, float height)
        {
            ...
            {
                Rect shadowRect = target.hierarchy.parent.contentRect;
        ...
        protected void OnMouseMove(MouseMoveEvent e)
        {
            ...
            PositionChanged?.Invoke(graphView.viewTransform.position);
            e.StopPropagation();
        }
