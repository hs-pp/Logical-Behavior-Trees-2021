...
namespace Logical.Editor.UIElements
{
    ...
    public class TabGroupElement : VisualElement
    {
        ...
        {
            var uxmlAsset = Resources.Load<VisualTreeAsset>(ResourceAssetPaths.TabGroupElement_UXML);
            uxmlAsset.CloneTree(this);
            this.styleSheets.Add(Resources.Load<StyleSheet>(ResourceAssetPaths.TabGroupElement_StyleSheet));
