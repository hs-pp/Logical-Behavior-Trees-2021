...
public class LibraryTabElement2 : TabContentElement
{
    ...
    private class RecentsController
    {
        ...
        private LibraryTabElement2 m_libraryTab = null;

        public RecentsController(LibraryTabElement2 libraryTab)
        {
    ...
    private class FavoritesController
    {
        ...
        public FavoritesController(LibraryTabElement2 libraryTab)
        {
            m_libraryTab = libraryTab;
    ...
    private class AllGraphsController
    {
        ...
        public AllGraphsController(LibraryTabElement2 libraryTab)
        {
